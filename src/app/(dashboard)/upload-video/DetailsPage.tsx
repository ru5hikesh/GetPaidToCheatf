...
export function DetailsPage({ onNext }: DetailsPageProps) {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="mx-auto max-w-4xl p-8">
        ...
        {/* Upload Area */}
        <div
          className={`relative mb-10 rounded border-dashed border-2 border-[#F0560066] bg-[#F056000D] transition-colors ${
            dragActive ? "border-[#F05600]" : ""
          } ${uploadedImage ? "p-0" : "p-16"}`}
